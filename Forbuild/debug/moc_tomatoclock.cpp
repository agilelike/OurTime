...
QT_MOC_LITERAL(1, 12, 11), // "clockUpdata"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 16) // "fade_on_fade_out"

    },
    "tomatoClock\0clockUpdata\0\0fade_on_fade_out"
};
...
void tomatoClock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clockUpdata(); break;
        case 1: _t->fade_on_fade_out(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject tomatoClock::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_tomatoClock.data,
      qt_meta_data_tomatoClock,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *tomatoClock::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_tomatoClock.stringdata0))
        return static_cast<void*>(const_cast< tomatoClock*>(this));
