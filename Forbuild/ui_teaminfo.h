...
public:
    ...
    void setupUi(QWidget *teaminfo)
    {
        ...
        checkBox->setGeometry(QRect(350, 28, 111, 31));
        QFont font;
        ...
        pushButton->setStyleSheet(QStringLiteral("border-color: rgb(118, 118, 118);"));
    ...
    void retranslateUi(QWidget *teaminfo)
    {
        ...
        label->setText(QApplication::translate("teaminfo", "\344\270\252\344\272\272\346\266\210\346\201\257\357\274\232", Q_NULLPTR));
